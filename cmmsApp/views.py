...
# CHANGE BY JYOTI - 11-Sep-2026: START - Email OTP backend for Industrial Automation Engineering website
# ============================================================
# CONTACT EMAIL OTP
# ============================================================
...
def _send_contact_otp_email(
    ...
    subject = (
        "Industrial Automation Engineering Email Verification Code"
    )
...
def request_demo_view(request):
    ...
    subject = "New Industrial Automation Engineering Enquiry"

    text_body = (
        "A new Industrial Automation Engineering enquiry request "
        "was submitted.\n\n"
        f"Submitted: {ts}\n"
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">
            New Industrial Automation Engineering Enquiry Request
        </h2>
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New website contact submission for Industrial Automation Engineering"
        text_body = "\n".join(
            [
                "New contact submission for Industrial Automation Engineering:",
...
def contact_block_submit(request):
    """
    Handles the Industrial Automation Engineering consulting/contact form.
    """
    ...
    # CHANGE BY JYOTI - 11-Sep-2026:
    # Industrial Automation Engineering email notification.
    subject = (
        f"[Industrial Automation Engineering Website] "
    ...
    text_body = "\n".join(
        [
            (
                ...
                "submitted for Industrial Automation Engineering:"
            ),
            f"Name: {name}",
            f"Email: {email}",
            (
